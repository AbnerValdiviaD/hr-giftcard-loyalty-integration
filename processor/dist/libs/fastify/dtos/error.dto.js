...
exports.MockCustomErrorResponse = exports.AuthErrorResponse = exports.ErrorResponse = exports.ErrorObject = void 0;
...
exports.MockCustomErrorResponse = typebox_1.Type.Object({
    status: typebox_1.Type.Object({
        state: typebox_1.Type.String(),
        errors: typebox_1.Type.Optional(typebox_1.Type.Array(exports.ErrorObject)),
    }),
