...
const errorHandler = (error, req, reply) => {
    ...
    else if (error instanceof giftcard_api_error_1.MockCustomError || error instanceof giftcard_api_error_1.MockApiError) {
...
const handleMockCustomError = (error, reply) => {
