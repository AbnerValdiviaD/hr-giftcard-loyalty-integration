...
exports.AbstractGiftCardService = void 0;
const connect_payments_sdk_1 = require("@commercetools/connect-payments-sdk");
class AbstractGiftCardService {
    ctCartService;
    ctPaymentService;
    ctOrderService;
    constructor(ctCartService, ctPaymentService, ctOrderService) {
...
exports.AbstractGiftCardService = AbstractGiftCardService;
