...
class HarryRosenGiftCardService extends abstract_giftcard_service_1.AbstractGiftCardService {
    ...
    async redeem(request) {
        try {
            logger_1.log.info('Authorizing gift card payment (checking balance only)', {
            ...
            for (const paymentRef of existingPayments) {
                try {
                    ...
                    if (existingCode === request.code) {
                        ...
                        logger_1.log.info('Gift card already applied - will create new payment with summed amount', {
                        ...
                        logger_1.log.info('Creating additional payment (multiple payments from same card allowed)', {
                    ...
                    logger_1.log.warn('Failed to check/update existing payment', {
                        error,
            ...
            logger_1.log.info('Payment authorized and added to cart (no funds captured yet)', {
                paymentId: payment.id,
